...
export function VentasHeader({ clientes }: VentasHeaderProps) {
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gestiona tus ventas y cobranzas</p>
        </div>
      ...
      <VentaDialog open={open} onOpenChange={setOpen} clientes={clientes} />
    </div>
  )
}
